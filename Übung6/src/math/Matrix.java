...
/**
 * Klasse zur Erzeugung von Matrizen, die einfache Rechenoperationen auf
 * Matrizen ausführen kann.
 * 
...
public class Matrix
{
	...
	{
		this.data = checkDimensions(data);
	}
	 ...
	 *             wenn Dimensionen unterschiedlich
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             wenn Matrizen nicht verkettbar.
	 */
	...
	private static float[][] checkDimensions(float[][] data) throws IllegalArgumentException {
		if(data.length == 0) 
		{
			throw new IllegalArgumentException("Leere Matrix");
		}
		if(data.length > 2)
		{
			for(int i = 1; i < data.length; i++)
			{
				...
				{
					throw new IllegalArgumentException("Daten für Matrix unterschiedlich lang.");
				}
			}
		}
		return data;
